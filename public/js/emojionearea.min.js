...
window = "undefined" != typeof __webpack_require__.g ? __webpack_require__.g : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {}, document = window.document || {}, function (a, b) {
   true && "object" == ( false ? 0 : _typeof(exports)) && "object" == ( false ? 0 : _typeof(module)) ? a(__webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = (a),
  ...
  function o(a, b, c) {
    ...
    var h = "";
    return b.uc_base && k > 4 ? (h = b.uc_base, b = b.uc_output.toUpperCase()) : h = b, a.replace("{name}", c || "").replace("{friendlyName}", g).replace("{img}", f + (k < 2 ? h.toUpperCase() : h) + "." + d).replace("{uni}", b).replace("{alt}", e.convert(b));
  }
  ...
  var x, y;
  window.getSelection && document.createRange ? (x = function x(a) {
  ...
  }) : document.selection && document.body.createTextRange && (x = function x(a) {
  ...
  function L(b, c, d) {
    ...
    d.search && v.addClass(F("with-search", !0)), b.searchSel = null, i.data(c.data()), a.each(d.attributes, function (a, b) {
      i.attr(a, b);
    });
    ...
    if (a.each(d.filters, function (c, e) {
      ...
      if ("recent" !== c || b.recentEmojis) {
        if ("tones" !== c) a("<i/>", {
          ...
          "data-filter": c,
          title: e.title
        }).wrapInner(p(e.icon, b.emojiTemplateAlt)).appendTo(t);else {
          if (!d.tones) return;
          f = 5;
        }
        ...
        do {
          ...
          g = 0 === f ? G("category").attr({
            ...
            name: c,
            "data-tone": f
          }).appendTo(z), f > 0 && (g.hide(), h = h.split("|").join("_tone" + f + "|") + "_tone" + f), "recent" === c && (h = H()), h = p(h, b.sprite ? '<i class="emojibtn" role="button" data-name="{name}" title="{friendlyName}"><i class="emojione-{uni}"></i></i>' : '<i class="emojibtn" role="button" data-name="{name}" title="{friendlyName}"><img class="emojioneemoji lazy-emoji" data-src="{img}"/></i>', !0).split("|").join(""), g.html(h), a('<div class="emojionearea-category-title"/>').text(e.title).prependTo(g);
        } while (--f > 0);
      }
    }), d.filters = null, b.sprite || (b.lasyEmoji = z.find(".lazy-emoji")), u = t.find(F("filter")), u.eq(0).addClass("active"), L = z.find(F("category-block")), A = z.find(F("category")), b.recentFilter = u.filter('[data-filter="recent"]'), b.recentCategory = A.filter("[name=recent]"), b.scrollArea = M, d.container ? a(d.container).wrapInner(O) : O.insertAfter(c), d.hideSource && c.hide(), b.setText(c[g]()), c[g](b.getText()), D.apply(b), b.standalone && !b.getText().length) {
    ...
    if (M.on("scroll", function () {
      ...
      c ? (M.addClass("skinnable"), L.hide().filter("[data-tone=" + c + "]").show(), u.removeClass("active")) : (M.removeClass("skinnable"), L.hide().filter("[data-tone=0]").show(), u.eq(0).click()), E.call(b), d.search && b.trigger("search.keypress");
      ...
      g && g.length ? (b.recentFilter.hasClass("active") && b.recentFilter.removeClass("active").next().addClass("active"), b.recentCategory.hide(), b.recentFilter.hide(), L.each(function () {
        var b = function b(a, _b) {
          var c = a.find('.emojibtn[data-name*="' + g + '"]');
          if (0 === c.length) a.data("tone") === _b && a.hide(), e.filter('[data-filter="' + a.attr("name") + '"]').hide();else {
            var d = a.find('.emojibtn:not([data-name*="' + g + '"])');
            d.hide(), c.show(), a.data("tone") === _b && a.show(), e.filter('[data-filter="' + a.attr("name") + '"]').show();
          }
        },
            c = a(this);
      ...
      }), R ? E.call(b) : M.trigger("scroll")) : (I(b, !0), L.filter('[data-tone="' + N.find("i.active").data("skin") + '"]:not([name="recent"])').show(), a(".emojibtn", L).show(), e.show(), E.call(b));
  ...
  function N(b) {
    var c = r();
    if (b = w(b), !M.isLoading) if (!e || u(t(e)) < 2) {
      M.isLoading = !0;
      var d;
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/emojionearea.min.js");
/******/ 	
/******/ })()
;
...
<div class="content">
    ...
    <div class="card bg-white">
        <div class="card-body">
            ...
            <form method="GET" action="{{route('settings.whatsapp_update')}}">
                @csrf
                <div class='form-group row'>
                    <div for="" class="col-md-6">
                        @if(setting('whatsapp.status') == 1)
                        <div class="pt-5 pl-5">
                            <h4>
                                {{__('To use whatsApp on your application')}}:
                            </h4>
                            <ol class="">
                                <li class="">{{__('Open WhatsApp on your phone')}}</li>
                                <li class="">
                                    <span dir="ltr" class="">{{__('Tap')}} <strong>
                                            <span dir="ltr" class="i0jNr">{{__('Menu')}} <span class="">
                                            ...
                                            <span dir="ltr" class="i0jNr">{{__('Settings')}} <span class="">
                                        ...
                                        </strong> {{__('and select')}} <strong>{{__('Linked Devices')}}</strong>
                                    </span>
                                </li>
                                <li class="">{{__('Point your phone to this screen to capture the code')}}</li>
                            </ol>
                        </div>
                        @else
                    ...
                    <div class="col-md-6">
                        <img src="{{ setting('whatsapp.last_qr') }}" alt="" style="height:300px">
                    </div>

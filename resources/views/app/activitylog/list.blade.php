                            ...
                            @else
                                @foreach($audits as $audit)
                                    <tr>
                                        ...
                                        <td width="1">
                                            @can('activitylog_delete')
                                                <form action="{{ route('activitylog.destroy', $audit->id) }}" method="POST">
                                                    @method('DELETE')
                                                    @csrf
                                                    <a href="#" class="deleteBtn" data-confirm-message="{{__("Are you sure you want to delete this ligne?")}}" data-toggle="tooltip" data-placement="top" title="{{__('Delete Activity')}}"><i class="material-icons md-18 text-grey">delete</i></a>
                                                </form>
                                            @endcan
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <x-user-log-activity :audit="$audit" showName="false" />
                                        </td>
